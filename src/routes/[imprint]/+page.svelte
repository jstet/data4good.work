<div class="flex justify-center">
    <div class="max-w-[600px] prose py-12">
        <h1 class="">Imprint</h1>
        ...
        <p>
            ...
            informational purposes only. We strive to keep the information up to
            date and accurate, but we make no representations or warranties of
        ...
        <p>
            The inclusion of any company or organization on this website does
            not imply endorsement or recommendation. We do not guarantee the
            quality of the products, services, or initiatives provided by these
            companies. It is recommended that you conduct your own research and
            due diligence before engaging with any company or organization
            listed here.
        </p>
        <p>
        ...
        <p>
            Through this website, you can visit other websites that are not
